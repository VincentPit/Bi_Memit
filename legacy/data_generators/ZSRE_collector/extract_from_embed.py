...
output_path = "/scratch/$USER/KeDataCollector/mend_dataset_count"
with open(f"{output_path}/zsre_mend_train_count.json", "w") as file:
    json.dump(data, file, indent=4)
with open(f"{output_path}/train_relation_counts.json", "w") as file:
    json.dump(relation_counts, file, indent=4)

print("Relation extraction and counting completed. Results saved to 'mend_dataset_count/zsre_mend_train_count.json' and 'train_relation_counts.json'.")
